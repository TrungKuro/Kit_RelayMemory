...
// ------------------------------------------------
//<Resources !Start!>
extern "C" const unsigned short Switch_Off_70x18[] PROGMEM;
extern "C" const unsigned short Switch_On_70x18[] PROGMEM;
//<Resources !End!>
...
extern gslc_tsElemRef* box41Stu1;
extern gslc_tsElemRef* box41Stu2;
extern gslc_tsElemRef* box41Stu3;
extern gslc_tsElemRef* box41Stu4;
extern gslc_tsElemRef* box41Tea1;
extern gslc_tsElemRef* box41Tea2;
extern gslc_tsElemRef* box41Tea3;
extern gslc_tsElemRef* box41Tea4;
extern gslc_tsElemRef* btn10Stu;
extern gslc_tsElemRef* btn31Res;
extern gslc_tsElemRef* tog22R1;
extern gslc_tsElemRef* tog22R2;
extern gslc_tsElemRef* tog22R3;
extern gslc_tsElemRef* tog22R4;
extern gslc_tsElemRef* tog42R1;
extern gslc_tsElemRef* tog42R2;
extern gslc_tsElemRef* tog42R3;
extern gslc_tsElemRef* tog42R4;
extern gslc_tsElemRef* txt21Pas;
...
void InitGUIslice_gen()
{
  ...
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_GRAY_DK1,GSLC_COL_GRAY_DK3,GSLC_COL_GRAY);
  gslc_ElemSetRoundEn(&m_gui, pElemRef, true);
  btn10Stu = pElemRef;
  ...
  // Create TXT21_PAS runtime modifiable text
  static char m_sDisplayText4[5] = "";
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT21_PAS,PG21,(gslc_tsRect){15,15,290,35},
    (char*)m_sDisplayText4,5,E_NOTOSANSBOLD12);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  txt21Pas = pElemRef;
  ...
  gslc_ElemSetCol(&m_gui,pElemRef,GSLC_COL_WHITE,GSLC_COL_RED_LT1,GSLC_COL_WHITE);
  box41Tea1 = pElemRef;
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT41_TEA1,PG41,(gslc_tsRect){30,50,40,25},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT41_TEA2,PG41,(gslc_tsRect){100,50,40,25},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT41_TEA3,PG41,(gslc_tsRect){180,50,40,25},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT41_TEA4,PG41,(gslc_tsRect){250,50,40,25},
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT41_STU1,PG41,(gslc_tsRect){30,145,40,25},
    (char*)"1",0,E_NOTOSANSBOLD10);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_BLACK);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT41_STU2,PG41,(gslc_tsRect){100,145,40,25},
    (char*)"2",0,E_NOTOSANSBOLD10);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_BLACK);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT41_STU3,PG41,(gslc_tsRect){180,145,40,25},
    (char*)"3",0,E_NOTOSANSBOLD10);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_BLACK);
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT41_STU4,PG41,(gslc_tsRect){250,145,40,25},
    (char*)"4",0,E_NOTOSANSBOLD10);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  gslc_ElemSetTxtCol(&m_gui,pElemRef,GSLC_COL_BLACK);
  ...
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,BTN42_RES,PG42,
    (gslc_tsRect){20,130,120,50},(char*)"RESET ALL",0,E_NOTOMONO6,&CbBtnCommon);
  gslc_ElemSetRoundEn(&m_gui, pElemRef, true);
  
  // create BTN42_ALL button with text label
  pElemRef = gslc_ElemCreateBtnTxt(&m_gui,BTN42_ALL,PG42,
    (gslc_tsRect){180,130,120,50},(char*)"SET ALL",0,E_NOTOMONO6,&CbBtnCommon);
  gslc_ElemSetRoundEn(&m_gui, pElemRef, true);
  ...
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,TOG42_RL1,PG42,&m_asXToggle2,
    (gslc_tsRect){25,20,60,40},GSLC_COL_GRAY_LT1,GSLC_COL_RED_LT1,GSLC_COL_GREEN_LT1,
    false,true,&CbBtnCommon);
  tog42R1 = pElemRef;
  
  // Create toggle button TOG42_RL2
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,TOG42_RL2,PG42,&m_asXToggle3,
    (gslc_tsRect){95,20,60,40},GSLC_COL_GRAY_LT1,GSLC_COL_RED_LT1,GSLC_COL_GREEN_LT1,
    false,true,&CbBtnCommon);
  tog42R2 = pElemRef;
  
  // Create toggle button TOG42_RL3
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,TOG42_RL3,PG42,&m_asXToggle4,
    (gslc_tsRect){165,20,60,40},GSLC_COL_GRAY_LT1,GSLC_COL_RED_LT1,GSLC_COL_GREEN_LT1,
    false,true,&CbBtnCommon);
  tog42R3 = pElemRef;
  
  // Create toggle button TOG42_RL4
  pElemRef = gslc_ElemXTogglebtnCreate(&m_gui,TOG42_RL4,PG42,&m_asXToggle5,
    (gslc_tsRect){235,20,60,40},GSLC_COL_GRAY_LT1,GSLC_COL_RED_LT1,GSLC_COL_GREEN_LT1,
    false,true,&CbBtnCommon);
  tog42R4 = pElemRef;
  ...
  pElemRef = gslc_ElemCreateImg(&m_gui,IMG22_ON,PG22,(gslc_tsRect){75,146,70,18},
    gslc_GetImageFromProg((const unsigned char*)Switch_On_70x18,GSLC_IMGREF_FMT_BMP24));
 
  // Create IMG22_OFF using Image 
  pElemRef = gslc_ElemCreateImg(&m_gui,IMG22_OFF,PG22,(gslc_tsRect){220,146,70,18},
    gslc_GetImageFromProg((const unsigned char*)Switch_Off_70x18,GSLC_IMGREF_FMT_BMP24));
  ...
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT32_1,PG32,(gslc_tsRect){20,60,280,40},
    (char*)"Are you sure you want",0,E_NOTOSANSBOLD12);
  gslc_ElemSetTxtAlign(&m_gui,pElemRef,GSLC_ALIGN_MID_MID);
  gslc_ElemSetFillEn(&m_gui,pElemRef,false);
  
  // Create TXT32_2 text label
  pElemRef = gslc_ElemCreateTxt(&m_gui,TXT32_2,PG32,(gslc_tsRect){20,100,280,40},
